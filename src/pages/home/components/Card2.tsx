      ...
      <div className="relative flex min-w-0 break-words bg-white rounded-xl mb-4 shadow-xl">
        <div className="flex items-center justify-between w-full p-4">
          <div className="flex flex-col">
            <span className="font-bold text-2xl xl:text-xl">{zh_name}</span>
            <p className="text-lg xl:text-md mt-3">{totalStr}</p>
          </div>
          <div className="flex flex-col items-end">
            <p className="text-xl xl:text-lg font-bold text-sRed">買進 {tranNumber(buy)}</p>
            <p className="text-xl xl:text-lg font-bold text-sGreen mt-4">賣出 {tranNumber(sell)}</p>
          </div>
        </div>
      </div>
    </>
